...
const HeaderDropdown = ({ setBoardModalOpen, setOpenDropdown }) => {
  ...
  return (
    <div
      className="py-10
  px-6 absolute left-0 right-0 bottom-[-100vh] top-16 bg-[#00000080]"
      onClick={(e) => {
    ...
    >
      ...
      <div className="bg-white dark:bg-[#2b2c37] shadow-md shadow-[#364e7e1a] w-full py-4 rounded-xl">
        <h3 className="text-gray-300 font-semibold mx-4 mb-8">
